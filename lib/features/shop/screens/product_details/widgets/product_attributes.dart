...
import 'package:fyp_store/common/widgets/chips/choice_chip.dart';
        ...
        Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 8,
              children: [
                MyChoiceChip(text: 'EU 34', selected: false, onSelected: (value) { }),
                MyChoiceChip(text: 'EU 36', selected: true, onSelected: (value) { }),
